...
# 12 "MCAL/Timers/Timer0/../../GPIO/GPIO.h"
# 1 "MCAL/Timers/Timer0/../../GPIO/GPIO_REGISTER.h" 1
# 11 "MCAL/Timers/Timer0/../../GPIO/GPIO_REGISTER.h"
# 1 "MCAL/Timers/Timer0/../../GPIO/../MCAL_STD_TYPES.h" 1
# 11 "MCAL/Timers/Timer0/../../GPIO/../MCAL_STD_TYPES.h"
# 1 "MCAL/Timers/Timer0/../../GPIO/../COMPILER.h" 1
# 11 "MCAL/Timers/Timer0/../../GPIO/../MCAL_STD_TYPES.h" 2
# 93 "MCAL/Timers/Timer0/../../GPIO/../MCAL_STD_TYPES.h"
...
# 11 "MCAL/Timers/Timer0/../../GPIO/GPIO_REGISTER.h" 2
# 12 "MCAL/Timers/Timer0/../../GPIO/GPIO.h" 2

# 1 "MCAL/Timers/Timer0/../../GPIO/GPIO_CONFIG.h" 1
# 11 "MCAL/Timers/Timer0/../../GPIO/GPIO_CONFIG.h"
# 1 "MCAL/Timers/Timer0/../../GPIO/GPIO.h" 1
# 11 "MCAL/Timers/Timer0/../../GPIO/GPIO_CONFIG.h" 2
# 13 "MCAL/Timers/Timer0/../../GPIO/GPIO.h" 2
# 30 "MCAL/Timers/Timer0/../../GPIO/GPIO.h"
typedef enum
{
    GPIO_OUTPUT=0,
    GPIO_INPUT=1
...
# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h"
# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 1
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h"
# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_private.h" 1
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2

# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 13 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager_config.h" 1
# 13 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 1
# 11 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h"
# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 1
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
...
# 12 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2


# 1 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 14 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2
# 46 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
typedef enum
{
...
void (ADC_ISR)(void);
# 11 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 2
# 14 "MCAL/Timers/Timer0/../../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2
# 13 "MCAL/Timers/Timer0/Timer0.h" 2
# 54 "MCAL/Timers/Timer0/Timer0.h"
typedef enum
{
...
# 2 "MCAL/Timers/Timer0/Timer0.c" 2
...
STD_RETURN_TYPE TIMER_0_init(timer0_t *timer)
{
    ...
    else
    {
        ...
        if(0==timer->timer_0_edge_transition)
        {
            (T0CONbits.T0SE=0);
        }
        else if(1==timer->timer_0_edge_transition)
        {
            (T0CONbits.T0SE=1);
        }
        else
        ...
        if(1==timer->PRESCALER_STATE)
        {
            (T0CONbits.PSA=0);
            (T0CONbits.T0PS=timer->Timer0_prescaler);
        }
        else if(0==timer->PRESCALER_STATE)
        {
            (T0CONbits.PSA=1);
        }
        else
        ...
        (TMR0H=timer->timer0_preloaded_value>>8);
        (TMR0L=(uint8)timer->timer0_preloaded_value);
        (T0CONbits.TMR0ON=1);
    }
    return ret;
}
...
STD_RETURN_TYPE TIMER_0_read(timer0_t *timer ,uint16 *value)
{
    ...
    else
    {
        if(1==timer->timer0_register_size)
        {
            l_timer0_low_register=(TMR0L);
            *value=(uint16)l_timer0_low_register;
        }
        else if(0==timer->timer0_register_size)
        {
            l_timer0_low_register=(TMR0L);
            l_timer0_high_register=(TMR0H);
...
void TIMER0_INTERRUPT_HANDLER(void)
{
    ...
    (TMR0H=timer0_ISR_preload_value>>8);
    (TMR0L=(uint8)timer0_ISR_preload_value);
}
