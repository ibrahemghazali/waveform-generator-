...
# 1 "MCAL/SPI/../GPIO/GPIO_REGISTER.h" 1
# 11 "MCAL/SPI/../GPIO/GPIO_REGISTER.h"
# 1 "MCAL/SPI/../GPIO/../MCAL_STD_TYPES.h" 1
# 11 "MCAL/SPI/../GPIO/../MCAL_STD_TYPES.h"
# 1 "MCAL/SPI/../GPIO/../COMPILER.h" 1
# 11 "MCAL/SPI/../GPIO/../MCAL_STD_TYPES.h" 2
# 93 "MCAL/SPI/../GPIO/../MCAL_STD_TYPES.h"
...
# 11 "MCAL/SPI/../GPIO/GPIO_REGISTER.h" 2
# 12 "MCAL/SPI/../GPIO/GPIO.h" 2

# 1 "MCAL/SPI/../GPIO/GPIO_CONFIG.h" 1
# 11 "MCAL/SPI/../GPIO/GPIO_CONFIG.h"
# 1 "MCAL/SPI/../GPIO/GPIO.h" 1
# 11 "MCAL/SPI/../GPIO/GPIO_CONFIG.h" 2
# 13 "MCAL/SPI/../GPIO/GPIO.h" 2
# 30 "MCAL/SPI/../GPIO/GPIO.h"
typedef enum
{
    GPIO_OUTPUT=0,
    GPIO_INPUT=1
...
# 1 "MCAL/SPI/SPI_config.h" 1
# 12 "MCAL/SPI/SPI_config.h"
# 1 "MCAL/SPI/SPI_private.h" 1
# 12 "MCAL/SPI/SPI_config.h" 2
# 14 "MCAL/SPI/SPI.h" 2

# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 12 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h"
# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 1
# 12 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h"
# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_private.h" 1
# 12 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2

# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 13 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2
# 12 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager_config.h" 1
# 13 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 1
# 11 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h"
# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 1
# 14 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
# 1 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 14 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2
# 46 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
typedef enum
{
...
void (ADC_ISR)(void);
# 11 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 2
# 14 "MCAL/SPI/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2
# 15 "MCAL/SPI/SPI.h" 2
# 66 "MCAL/SPI/SPI.h"
typedef struct
{
...
STD_RETURN_TYPE SPI_init(SPI_t *SPI_obj)
{
    ...
    else
    {
        ...
        (SSPSTATbits.CKE=0);
        (SSPCON1bits.CKP=1);
        if(((2==SPI_obj->SPI_MODE)||(1==SPI_obj->SPI_MODE)||(0==SPI_obj->SPI_MODE)))
        {
        ...
        else if(((5==SPI_obj->SPI_MODE)||(4==SPI_obj->SPI_MODE)))
        {
            SCK_pin.direction=GPIO_INPUT;
            (SSPCON1bits.SSPM=SPI_obj->SPI_MODE);
            ret=GPIO_PIN_initialize(&SCK_pin);
            if(5==SPI_obj->SPI_MODE)
            {
        ...
        if(1==SPI_obj->SPI_interrupt_enable)
        {
            (PIE1bits.SSPIE=0);
