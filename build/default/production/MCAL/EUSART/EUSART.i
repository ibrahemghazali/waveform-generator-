...
# 11 "MCAL/EUSART/EUSART.h" 2

# 1 "MCAL/EUSART/EUSART_private.h" 1
# 12 "MCAL/EUSART/EUSART.h" 2

# 1 "MCAL/EUSART/EUSART_config.h" 1
# 13 "MCAL/EUSART/EUSART.h" 2

# 1 "MCAL/EUSART/../MCAL_STD_TYPES.h" 1
# 11 "MCAL/EUSART/../MCAL_STD_TYPES.h"
# 1 "MCAL/EUSART/../COMPILER.h" 1
# 11 "MCAL/EUSART/../MCAL_STD_TYPES.h" 2
# 93 "MCAL/EUSART/../MCAL_STD_TYPES.h"
...
# 1 "MCAL/EUSART/../GPIO/GPIO.h" 1
# 12 "MCAL/EUSART/../GPIO/GPIO.h"
# 1 "MCAL/EUSART/../GPIO/GPIO_REGISTER.h" 1
# 12 "MCAL/EUSART/../GPIO/GPIO.h" 2

# 1 "MCAL/EUSART/../GPIO/GPIO_CONFIG.h" 1
# 11 "MCAL/EUSART/../GPIO/GPIO_CONFIG.h"
# 1 "MCAL/EUSART/../GPIO/GPIO.h" 1
# 11 "MCAL/EUSART/../GPIO/GPIO_CONFIG.h" 2
# 13 "MCAL/EUSART/../GPIO/GPIO.h" 2
# 30 "MCAL/EUSART/../GPIO/GPIO.h"
typedef enum
{
    GPIO_OUTPUT=0,
    GPIO_INPUT=1
...
# 15 "MCAL/EUSART/EUSART.h" 2

# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 12 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h"
# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 1
# 12 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h"
# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_private.h" 1
# 12 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2

# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 13 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2
# 12 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager_config.h" 1
# 13 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 1
# 11 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h"
# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 1
# 14 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
# 1 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 14 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2
# 46 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
typedef enum
{
...
void (ADC_ISR)(void);
# 11 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 2
# 14 "MCAL/EUSART/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2
# 16 "MCAL/EUSART/EUSART.h" 2
# 159 "MCAL/EUSART/EUSART.h"
typedef struct
{
...
STD_RETURN_TYPE EUSART_asynchronous_init(const EUSART_t *eusart_obj)
{
    ...
    else
    {
        ...
        do { TXSTA1bits.SYNC=0; TXSTA1bits.BRGH=1; BAUDCONbits.BRG16=0; }while(0);;
        (SPBRG=(uint8)(((8000000UL)/(eusart_obj->baud_rate*16))-1));;
...
static STD_RETURN_TYPE EUSART_TX_asynchronous_init(const TX_t *eusart_obj)
{
    ...
    {
        if(1==eusart_obj->TX_enable)
        {
            (TXSTAbits.TXEN=1);
            if(1==eusart_obj->TX_interrupt_enable)
            {
            ...
            (INTCONbits.GIEH=1);
            (INTCONbits.GIEL=1);
            if(1==eusart_obj->TX_priority)
            {
                (IPR1bits.TXIP=1);
            }
            else if(0==eusart_obj->TX_priority)
            {
                (IPR1bits.TX1IP=0);
            }
            else
            ...
            if(1==eusart_obj->TX_9bit_mode_enable)
            {
                (TXSTA1bits.TX9=1);
            }
            else
...
static STD_RETURN_TYPE EUSART_RX_asynchronous_init(const RX_t *eusart_obj)
{
    ...
    else
    {
        if(1==eusart_obj->RX_enable)
        {
            ...
            (RCSTA1bits.CREN=1);
            if(1==eusart_obj->RX_interrupt_enable)
            {
            ...
            (INTCONbits.GIEH=1);
            (INTCONbits.GIEL=1);
            if(1==eusart_obj->RX_priority)
            {
                (IPR1bits.RC1IP=1);
            }
            else if(0==eusart_obj->RX_priority)
            {
                (IPR1bits.RC1IP=0);
            }
            else
            ...
            if(1==eusart_obj->RX_9bit_mode_enable)
            {
                (RCSTA1bits.RX9=1);
            }
            else
...
void TX_INTERRUPT_HANDLER(void)
{
    ...
    {
        (TXREG=interrupt_data_transmitting);
...
void RX_INTERRUPT_HANDLER(void)
{
    ...
    {
        *interrupt_data_receiving=(RCREG);
