...
# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 12 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h"
# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 1
# 12 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager_config.h" 1
# 13 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 1
# 11 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h"
# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 1
# 12 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
...
# 12 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2

# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../../ADC/ADC_config.h" 1
# 13 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2

# 1 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 14 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2
# 46 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
typedef enum
{
...
void (ADC_ISR)(void);
# 11 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 2
# 14 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2
# 13 "MCAL/ADC/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../../ADC/ADC_config.h" 2
# 12 "MCAL/ADC/ADC.h" 2


# 1 "MCAL/ADC/../MCAL_STD_TYPES.h" 1
# 11 "MCAL/ADC/../MCAL_STD_TYPES.h"
# 1 "MCAL/ADC/../COMPILER.h" 1
# 11 "MCAL/ADC/../MCAL_STD_TYPES.h" 2
# 93 "MCAL/ADC/../MCAL_STD_TYPES.h"
...
static STD_RETURN_TYPE ADC_input_pin(ADC_CHANNEL_t input_channel)
{
    ...
    {
            case ADC_CHANNEL_0: (TRISA|=(1<<0)); break;
            case ADC_CHANNEL_1: (TRISA|=(1<<1)); break;
            case ADC_CHANNEL_2: (TRISA|=(1<<2)); break;
            case ADC_CHANNEL_3: (TRISA|=(1<<3)); break;
            case ADC_CHANNEL_4: (TRISA|=(1<<5)); break;

            case ADC_CHANNEL_5: (TRISE|=(1<<0)); break;
            case ADC_CHANNEL_6: (TRISE|=(1<<1)); break;
            case ADC_CHANNEL_7: (TRISE|=(1<<2)); break;

            case ADC_CHANNEL_8:(TRISB|=(1<<2)); break;
            case ADC_CHANNEL_9:(TRISB|=(1<<3)); break;
            case ADC_CHANNEL_10:(TRISB|=(1<<1)); break;
            case ADC_CHANNEL_11:(TRISB|=(1<<4)); break;
            case ADC_CHANNEL_12:(TRISB|=(1<<0)); break;
