...
# 1 "MCAL/CCP/CCP.h" 1
# 11 "MCAL/CCP/CCP.h"
# 1 "MCAL/CCP/CCP_private.h" 1
# 11 "MCAL/CCP/CCP.h" 2

# 1 "MCAL/CCP/CCP_confg.h" 1
# 12 "MCAL/CCP/CCP.h" 2

# 1 "MCAL/CCP/../MCAL_STD_TYPES.h" 1
# 11 "MCAL/CCP/../MCAL_STD_TYPES.h"
# 1 "MCAL/CCP/../COMPILER.h" 1
# 11 "MCAL/CCP/../MCAL_STD_TYPES.h" 2
# 93 "MCAL/CCP/../MCAL_STD_TYPES.h"
...
# 1 "MCAL/CCP/../GPIO/GPIO_REGISTER.h" 1
# 12 "MCAL/CCP/../GPIO/GPIO.h" 2

# 1 "MCAL/CCP/../GPIO/GPIO_CONFIG.h" 1
# 11 "MCAL/CCP/../GPIO/GPIO_CONFIG.h"
# 1 "MCAL/CCP/../GPIO/GPIO.h" 1
# 11 "MCAL/CCP/../GPIO/GPIO_CONFIG.h" 2
# 13 "MCAL/CCP/../GPIO/GPIO.h" 2
# 30 "MCAL/CCP/../GPIO/GPIO.h"
typedef enum
{
    GPIO_OUTPUT=0,
    GPIO_INPUT=1
...
# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h"
# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 1
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h"
# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_private.h" 1
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2

# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 13 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/ADC_config.h" 2
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager_config.h" 1
# 13 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../../ADC/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2

# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 1
# 11 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h"
# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 1
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
...
# 12 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2


# 1 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 1
# 14 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h" 2
# 46 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/INTERRUPT_manager.h"
typedef enum
{
...
void (ADC_ISR)(void);
# 11 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/INTERNAL_INTERRUPT_config.h" 2
# 14 "MCAL/CCP/../INTERRUPT/INTERNAL_INTERRUPT/../INTERRUPT_manager/../INTERNAL_INTERRUPT/INTERNAL_INTERRUPT.h" 2
# 15 "MCAL/CCP/CCP.h" 2

# 1 "MCAL/CCP/../Timers/TIMER1/Timer1.h" 1
# 74 "MCAL/CCP/../Timers/TIMER1/Timer1.h"
typedef enum
{
...
# 1 "MCAL/CCP/../Timers/Timer2/Timer2.h" 1
# 29 "MCAL/CCP/../Timers/Timer2/Timer2.h"
typedef enum
{
...
# 1 "MCAL/CCP/../Timers/Timer3/Timer3.h" 1
# 51 "MCAL/CCP/../Timers/Timer3/Timer3.h"
typedef struct
{
...
static CCP1_ONE_INIT=0;
static CCP2_ONE_INIT=0;
...
STD_RETURN_TYPE CCP_capture_init(const CCP_t *ccp_pin)
{
    ...
    {
        do { T3CONbits.T3CCP1=((ccp_pin->ccp_capture_mode_config.timer_mode_select>>0)&(1)); T3CONbits.T3CCP2=((ccp_pin->ccp_capture_mode_config.timer_mode_select>>1)&(1)); }while(0);;

        if((0==CCP1_ONE_INIT)&&(0==ccp_pin->ccp_capture_mode_config.capture_pin))
        {
            CCP1_ONE_INIT=1;
            CCP1_pin_config.direction=GPIO_INPUT;
            GPIO_PIN_initialize(&CCP1_pin_config);
            if((7>=ccp_pin->ccp_capture_mode_config.capture_varient_mode)&&(ccp_pin->ccp_capture_mode_config.capture_varient_mode>=4))
            {
                (CCP1CONbits.CCP1M=ccp_pin->ccp_capture_mode_config.capture_varient_mode);
            }
            else
            {
                ret=(STD_RETURN_TYPE)0x00;
          ...
          if(1==ccp_pin->ccp_capture_mode_config.capture_priority)
          {
              (IPR1bits.CCP1IP=1);
          }
          else
        ...
        else if((0==CCP2_ONE_INIT)&&(1==ccp_pin->ccp_capture_mode_config.capture_pin))
        {
            CCP2_ONE_INIT=1;
            ...
            if((7>=ccp_pin->ccp_capture_mode_config.capture_varient_mode)&&(ccp_pin->ccp_capture_mode_config.capture_varient_mode>=4))
            {
                (CCP2CONbits.CCP2M=ccp_pin->ccp_capture_mode_config.capture_varient_mode);
            }
            else
            {
                ret=(STD_RETURN_TYPE)0x00;
...
{
   STD_RETURN_TYPE ret=(STD_RETURN_TYPE)0x01;
    if((0==ccp_pin)||(0==capture_value))
    {
        ret=(STD_RETURN_TYPE)0x00;
    }
    else
    {
        if(0==ccp_pin->ccp_capture_mode_config.capture_pin)
        {
            *capture_value=((uint16)(CCPR1L+((uint16)CCPR1H<<8)));
        }
        else if(1==ccp_pin->ccp_capture_mode_config.capture_pin)
        {
            *capture_value=((uint16)(CCPR2L+((uint16)CCPR2H<<8)));
        }
        else
        {
            ret=(STD_RETURN_TYPE)0x00;
...
STD_RETURN_TYPE CCP_change_capture_rising_to_falling(const CCP_t *ccp_pin)
{
    ...
    else
    {
        if(0==ccp_pin->ccp_capture_mode_config.capture_pin)
        {
            if(5==ccp_pin->ccp_capture_mode_config.capture_varient_mode)
            {
                (CCP1CONbits.CCP1M=4);
            }
            else
...
STD_RETURN_TYPE CCP_change_capture_falling_to_rising(const CCP_t *ccp_pin)
{
 STD_RETURN_TYPE ret=(STD_RETURN_TYPE)0x01;
    ...
    else
    {
        if(0==ccp_pin->ccp_capture_mode_config.capture_pin)
        {
            if(4==ccp_pin->ccp_capture_mode_config.capture_varient_mode)
            {
                (CCP1CONbits.CCP1M=5);
            }
            else
...
STD_RETURN_TYPE CCP_compare_init(const CCP_t *ccp_pin)
{
    ...
    {
        do { T3CONbits.T3CCP1=((ccp_pin->ccp_compare_mode_config.timer_mode_select>>0)&(1)); T3CONbits.T3CCP2=((ccp_pin->ccp_compare_mode_config.timer_mode_select>>1)&(1)); }while(0);;

        if((0==CCP1_ONE_INIT)&&(0==ccp_pin->ccp_compare_mode_config.compare_pin))
        {
            CCP1_ONE_INIT=1;
            CCP1_pin_config.direction=GPIO_OUTPUT;
            GPIO_PIN_initialize(&CCP1_pin_config);
            do { CCPR1L=(uint8)ccp_pin->ccp_compare_mode_config.compare_value; CCPR1H=(uint8)((ccp_pin->ccp_compare_mode_config.compare_value)>>8); }while(0);;
            if(((ccp_pin->ccp_compare_mode_config.Compare_varient_mode<=11)&&(ccp_pin->ccp_compare_mode_config.Compare_varient_mode>=8))
              ||(2==ccp_pin->ccp_compare_mode_config.Compare_varient_mode))
            {
                (CCP1CONbits.CCP1M=ccp_pin->ccp_compare_mode_config.Compare_varient_mode);
            ...
            if(1==ccp_pin->ccp_compare_mode_config.Compare_priority)
            {
                (IPR1bits.CCP1IP=1);
            }
            else if(0==ccp_pin->ccp_compare_mode_config.Compare_priority)
            {
                (IPR1bits.CCP1IP=0);
            }
            else
        ...
        else if((0==CCP2_ONE_INIT)&&(1==ccp_pin->ccp_compare_mode_config.compare_pin))
        {
            CCP2_ONE_INIT=1;
            CCP2_pin_config.direction=GPIO_OUTPUT;
            GPIO_PIN_initialize(&CCP2_pin_config);
            do { CCPR2L=(uint8)ccp_pin->ccp_compare_mode_config.compare_value; CCPR2H=(uint8)((ccp_pin->ccp_compare_mode_config.compare_value)>>8); }while(0);;
            if(((ccp_pin->ccp_compare_mode_config.Compare_varient_mode<=11)&&(ccp_pin->ccp_compare_mode_config.Compare_varient_mode>=8))
              ||(2==ccp_pin->ccp_compare_mode_config.Compare_varient_mode))
            {
                (CCP2CONbits.CCP2M=ccp_pin->ccp_compare_mode_config.Compare_varient_mode);
...
STD_RETURN_TYPE CCP_set_compare_value(const CCP_t *ccp_pin,uint16 compare_value)
{
    ...
    {
        if(0==ccp_pin->ccp_compare_mode_config.compare_pin)
        {
            do { CCPR1L=(uint8)ccp_pin->ccp_compare_mode_config.compare_value; CCPR1H=(uint8)((ccp_pin->ccp_compare_mode_config.compare_value)>>8); }while(0);;
        }
        else if (1==ccp_pin->ccp_compare_mode_config.compare_pin)
        {
             do { CCPR2L=(uint8)ccp_pin->ccp_compare_mode_config.compare_value; CCPR2H=(uint8)((ccp_pin->ccp_compare_mode_config.compare_value)>>8); }while(0);;
        }
        else
...
STD_RETURN_TYPE CCP_change_compare_varient_mode(const CCP_t *ccp_pin,uint8 new_mode)
{
    ...
    else
    {
        if(0==ccp_pin->ccp_compare_mode_config.compare_pin)
        {
            if(((((11>=ccp_pin->ccp_compare_mode_config.Compare_varient_mode)&&(8<=ccp_pin->ccp_compare_mode_config.Compare_varient_mode))||(2==ccp_pin->ccp_compare_mode_config.Compare_varient_mode)))
                    &&((((11>=new_mode)&&(8<=new_mode))||(2==new_mode))))
            {
                (CCP1CONbits.CCP1M=new_mode);
...
STD_RETURN_TYPE CCP_PWM_init(const CCP_t *ccp_pin)
{
    ...
    else
    {
        ...
        {
             top_value=(uint8)((8000000UL)/(ccp_pin->ccp_pwm_mode_config.PWM_Freq*4*(ccp_pin->ccp_pwm_mode_config.TIMER_postscaler+1)*1));
             top_value-=1;
        }
        else if(TIMER2_PRESCALER_DIV_BY_4==ccp_pin->ccp_pwm_mode_config.TIMER_prescaler)
        {
             top_value=(uint8)((8000000UL)/(ccp_pin->ccp_pwm_mode_config.PWM_Freq*4*(ccp_pin->ccp_pwm_mode_config.TIMER_postscaler+1)*4));
             top_value-=1;
        }
        else if(TIMER2_PRESCALER_DIV_BY_16==ccp_pin->ccp_pwm_mode_config.TIMER_prescaler)
        {
             top_value=(uint8)((8000000UL)/(ccp_pin->ccp_pwm_mode_config.PWM_Freq*4*(ccp_pin->ccp_pwm_mode_config.TIMER_postscaler+1)*16));
             top_value-=1;
        }
        else
        {
        ...
        (PR2=top_value);
        if(0==ccp_pin->ccp_pwm_mode_config.CCP_PIN)
        {
            CCP1_pin_config.direction=GPIO_OUTPUT;
            CCP1_pin_config.logic=GPIO_LOW;
            GPIO_PIN_initialize(&CCP1_pin_config);
            (CCP1CONbits.CCP1M=12);
            do { CCP1CONbits.DC1B0=(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100)>>0)&(1)); CCP1CONbits.DC1B1=(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100)>>1)&(1)); CCPR1L=(uint8)(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100))>>2); }while(0);;
        }
        else if(1==ccp_pin->ccp_pwm_mode_config.CCP_PIN)
        {
            CCP2_pin_config.direction=GPIO_OUTPUT;
            CCP2_pin_config.logic=GPIO_LOW;
            GPIO_PIN_initialize(&CCP2_pin_config);
            (CCP2CONbits.CCP2M=12);
            do { CCP2CONbits.DC2B0=(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100)>>0)&(1)); CCP2CONbits.DC2B1=(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100)>>1)&(1)); CCPR2L=(uint8)(((uint16)(((PR2+1)*ccp_pin->ccp_pwm_mode_config.duty_cycle*4)/100))>>2); }while(0);;
        }
        else
        {
...
STD_RETURN_TYPE CCP_PWM_set_duty_cycle(const CCP_t *ccp_pin,uint16 duty_cycle)
{
    ...
    else
    {
        if(0==ccp_pin->ccp_pwm_mode_config.CCP_PIN)
        {
            do { CCP1CONbits.DC1B0=(((uint16)(((PR2+1)*duty_cycle*4)/100)>>0)&(1)); CCP1CONbits.DC1B1=(((uint16)(((PR2+1)*duty_cycle*4)/100)>>1)&(1)); CCPR1L=(uint8)(((uint16)(((PR2+1)*duty_cycle*4)/100))>>2); }while(0);;
        }
        else if(1==ccp_pin->ccp_pwm_mode_config.CCP_PIN)
        {
            do { CCP2CONbits.DC2B0=(((uint16)(((PR2+1)*duty_cycle*4)/100)>>0)&(1)); CCP2CONbits.DC2B1=(((uint16)(((PR2+1)*duty_cycle*4)/100)>>1)&(1)); CCPR2L=(uint8)(((uint16)(((PR2+1)*duty_cycle*4)/100))>>2); }while(0);;
        }
        else
        {
