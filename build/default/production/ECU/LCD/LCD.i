...
STD_RETURN_TYPE ECU_LCD_8bit_init(LCD_8bit_t *lcd)
{
    ...
    else
    {
        ...
        ret=ECU_LCD_8bit_send_command(lcd,0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        ret=ECU_LCD_8bit_send_command(lcd,0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        ret=ECU_LCD_8bit_send_command(lcd,0x38);
        ret=ECU_LCD_8bit_send_command(lcd,0x01);
        ret=ECU_LCD_8bit_send_command(lcd,0x02);
        ret=ECU_LCD_8bit_send_command(lcd,0x0C);
...
STD_RETURN_TYPE ECU_LCD_8bit_send_data(LCD_8bit_t *lcd,uint8 data)
{
    ...
    else
    {
        ...
        for(L_counter=0;L_counter<8;L_counter++)
        {
            ret=GPIO_PIN_write_logic(&(lcd->data_pins[L_counter]),((data>>L_counter)&(1)));
        }
...
STD_RETURN_TYPE ECU_LCD_8bit_set_cursor(LCD_8bit_t *lcd,uint8 row,uint8 col)
{
    ...
    else
    {
        switch(row)
        {
            case 1: ret=ECU_LCD_8bit_send_command(lcd,0x80 +(col-1)); break;
            case 2: ret=ECU_LCD_8bit_send_command(lcd,0xC0 +(col-1)); break;
            case 3: ret=ECU_LCD_8bit_send_command(lcd,0x94 +(col-1)); break;
            case 4: ret=ECU_LCD_8bit_send_command(lcd,0xd4 +(col-1)); break;
...
STD_RETURN_TYPE ECU_LCD_8bit_send_command(LCD_8bit_t *lcd,uint8 command)
{
    ...
    else
    {
        ...
        for(L_counter=0;L_counter<8;L_counter++)
        {
            ret=GPIO_PIN_write_logic(&(lcd->data_pins[L_counter]),((command>>L_counter)&(1)));
        }
        ret=GPIO_PIN_write_logic(&(lcd->EN_pin),GPIO_HIGH);
        _delay((unsigned long)((5)*(8000000UL/4000000.0)));
        ret=GPIO_PIN_write_logic(&(lcd->EN_pin),GPIO_LOW);
...
STD_RETURN_TYPE ECU_LCD_8bit_send_special_character(LCD_8bit_t *lcd,uint8 *character,uint8 row,uint8 col,uint8 mem_pos)
{
    STD_RETURN_TYPE ret=(STD_RETURN_TYPE)0x01;
    uint8 L_counter=0;
    if(((void*)0)==lcd||((void*)0)==character)
    {
        ret=(STD_RETURN_TYPE)0x00;
    }
    else
    {
        ret=ECU_LCD_8bit_send_command(lcd,0x40 +(8*mem_pos));
        for(L_counter=0;L_counter<8;L_counter++)
        {
...
static STD_RETURN_TYPE LCD_send_higher_nibble(LCD_4bit_t *lcd,uint8 command_or_data)
{
    ...
    else
    {
        ...
        {
            ret=GPIO_PIN_write_logic(&(lcd->data_pins[L_counter]),((command_or_data>>4+L_counter)&(1)));
        }
    }
    return ret;
}
static STD_RETURN_TYPE LCD_send_lower_nibble(LCD_4bit_t *lcd,uint8 command_or_data)
{
    ...
    else
    {
        for(L_counter=0;L_counter<4;L_counter++)
        {
            ret=GPIO_PIN_write_logic(&(lcd->data_pins[L_counter]),((command_or_data>>L_counter)&(1)));
        }
    }
    return ret;
}
STD_RETURN_TYPE ECU_LCD_4bit_init(LCD_4bit_t *lcd)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*(8000000UL/4000.0)));
        ret=ECU_LCD_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        ret=ECU_LCD_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
       ret=ECU_LCD_4bit_send_command(lcd,0x38);
       ret=ECU_LCD_4bit_send_command(lcd,0x01);
       ret=ECU_LCD_4bit_send_command(lcd,0x02);
       ret=ECU_LCD_4bit_send_command(lcd,0x06);
       ret=ECU_LCD_4bit_send_command(lcd,0x0C);
       ret=ECU_LCD_4bit_send_command(lcd,0x28);
       ret=ECU_LCD_4bit_send_command(lcd,0x80);
...
STD_RETURN_TYPE ECU_LCD_4bit_set_cursor(LCD_4bit_t *lcd,uint8 row,uint8 col)
{
    ...
    else
    {
        switch(row)
        {
            case 1: ret=ECU_LCD_4bit_send_command(lcd,0x80 +(col-1)); break;
            case 2: ret=ECU_LCD_4bit_send_command(lcd,0xC0 +(col-1)); break;
            case 3: ret=ECU_LCD_4bit_send_command(lcd,0x94 +(col-1)); break;
            case 4: ret=ECU_LCD_4bit_send_command(lcd,0xd4 +(col-1)); break;
            default :ret=(STD_RETURN_TYPE)0x00;
        }
    }
    return ret;
...
STD_RETURN_TYPE ECU_LCD_4bit_send_special_character(LCD_4bit_t *lcd,uint8 *character,uint8 row,uint8 col,uint8 mem_pos)
{
    ...
    {
        ret=ECU_LCD_4bit_send_command(lcd,0x40 +(8*mem_pos));
        for(L_counter=0;L_counter<8;L_counter++)
        {
