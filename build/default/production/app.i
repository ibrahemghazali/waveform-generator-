...
# 1 "./ECU/LCD/LCD.h" 1
# 12 "./ECU/LCD/LCD.h"
# 1 "./ECU/LCD/LCD_config.h" 1
# 12 "./ECU/LCD/LCD.h" 2

# 1 "./ECU/LCD/../../MCAL/GPIO/GPIO.h" 1
# 12 "./ECU/LCD/../../MCAL/GPIO/GPIO.h"
# 1 "./ECU/LCD/../../MCAL/GPIO/GPIO_REGISTER.h" 1
# 11 "./ECU/LCD/../../MCAL/GPIO/GPIO_REGISTER.h"
# 1 "./ECU/LCD/../../MCAL/GPIO/../MCAL_STD_TYPES.h" 1
# 11 "./ECU/LCD/../../MCAL/GPIO/../MCAL_STD_TYPES.h"
# 1 "./ECU/LCD/../../MCAL/GPIO/../COMPILER.h" 1
# 11 "./ECU/LCD/../../MCAL/GPIO/../MCAL_STD_TYPES.h" 2
# 93 "./ECU/LCD/../../MCAL/GPIO/../MCAL_STD_TYPES.h"
...
# 11 "./ECU/LCD/../../MCAL/GPIO/GPIO_REGISTER.h" 2
# 12 "./ECU/LCD/../../MCAL/GPIO/GPIO.h" 2

# 1 "./ECU/LCD/../../MCAL/GPIO/GPIO_CONFIG.h" 1
# 11 "./ECU/LCD/../../MCAL/GPIO/GPIO_CONFIG.h"
# 1 "./ECU/LCD/../../MCAL/GPIO/GPIO.h" 1
# 11 "./ECU/LCD/../../MCAL/GPIO/GPIO_CONFIG.h" 2
...
# 13 "./ECU/SEVEN_SEGMENT/SEVEN_SEGMENT.h"
...
# 1 "./ECU/KEYPAD/KEYPAD_config.h" 1
# 11 "./ECU/KEYPAD/KEYPAD_config.h"
# 1 "./ECU/KEYPAD/KEYPAD_config.h" 1
# 11 "./ECU/KEYPAD/KEYPAD_config.h" 2
...
typedef struct
{
    pin_config_t row_pins[4];
    pin_config_t col_pins[4];
}KEYPAD_t;
...
# 1 "./MCAL/Timers/TIMER1/Timer1.h" 1
# 74 "./MCAL/Timers/TIMER1/Timer1.h"
typedef enum
{
...
uint8 ret=(STD_RETURN_TYPE)0x01;
...
void initialize_app(void)
{
    ret=EEPROM_read_data(0x01,&current_mode);
    ...
    if(0==current_mode)
    {
        wave_generator.start_waveform=1;
    ...
    {
       wave_generator.start_waveform=5;
       ret=AD9833_init(&wave_generator);
       ret=ECU_LCD_4bit_send_string_with_pos(&Wave_form_lcd,"Triangle waveform",2,1);
    }
    else if(2==current_mode)
    {
       wave_generator.start_waveform=3;
        ret=AD9833_init(&wave_generator);
...
void ok_exit_button_interrupt(void)
{
    ...
    {
        current_screen=1;
        ECU_LCD_4bit_send_command(&Wave_form_lcd,0x01);
    ...
    else if(1==current_screen)
    {
        ...
        if(2==row_counter)
        {
            ...
            current_mode=0;
            EEPROM_write_data(0x01,current_mode);
        }
        else if(3==row_counter)
        {
            ret=ECU_LCD_4bit_send_string_with_pos(&Wave_form_lcd,"Triangle waveform",2,1);
